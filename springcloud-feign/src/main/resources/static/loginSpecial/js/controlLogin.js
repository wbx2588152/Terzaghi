...
layui.use('layer', function () {
    //
			var msgalert = '欢迎进入JKMALL后台管理系统';
   		var index = layer.alert(msgalert, { icon: 6, time: 4000, offset: 't', closeBtn: 0, title: '您好', btn: [], anim: 2, shade: 0 });
			layer.style(index, {
				color: '#777'
			});
    //     第一次弹出框
    ...
    $('input[type="button"]').click(function () {
        ...
        if (loginname == '') {
            ...
            //登陆
            var JsonData = { login: loginname, pwd: password, code: code };
            //此处做为ajax内部判断
            var url = "";
            var loginstatus="";
